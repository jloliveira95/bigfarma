package com.generation.bigfarma.controller;
...
public class CategoriaController {
    ...
    @PostMapping
    public ResponseEntity<Categoria> post(@Valid @RequestBody Categoria produto){
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(categoriaRepository.save(produto));
    }
    
    @PutMapping
    public ResponseEntity<Categoria> put(@Valid @RequestBody Categoria produto){
